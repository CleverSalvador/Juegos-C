...
color_rgb(40, 116, 166  );
rectangulo_lleno(8+x,15+y,42+x,40+y);  //25
...
rectangulo_lleno(44+x,25+y,48+x,50+y); 
        ...
        //izq punta izq 
  color_rgb(245, 103, 37);
rectangulo_lleno(0+x,10+y,2+x,37+y); 

   //izq punta der
  color_rgb(245, 103, 37);;
rectangulo_lleno(6+x,-10+y,8+x,45+y); 

   //der punta izq
  color_rgb(245, 103, 37);
rectangulo_lleno(42+x,-10+y,44+x,37+y); 

   //der punta der
 color_rgb(245, 103, 37);
rectangulo_lleno(48+x,10+y,50+x,37+y); 
...
rectangulo_lleno(18+x,10+y,32+x,25+y);
       ...
       //Frente medio
  color_rgb(176, 187, 173  );
rectangulo_lleno(23+x,3+y,27+x,20+y);
    
      //Frente medio izq
  color_rgb(244, 208, 63);
...
rectangulo_lleno(27+x,0+y,29+x,1+y);
  ...
  color_rgb(244, 208, 63); //alterado 85, 201, 54
rectangulo_lleno(15+x,25+y,19+x,45+y); //(Izq,alt,der,aba)
...
int main(){
    ...
    //Variables
    int PlayerX = 320, PlayerY = 400; /*posisicon del jugador*/
    ...
    while(t != ESCAPE){
        ...
        if (PlayerAlive){//
            ...
            if(PlayerBulletY<=0 && t==ESPACIO){
                 ...
                 PlaySound("laser2.wav",NULL,SND_ASYNC);//player
                 }
            if(t==ESPACIO){
        ...
        borra();
            ...
            //Paint Players Life //aqui me quede
            if (PlayerLifeCounter > 0) {
